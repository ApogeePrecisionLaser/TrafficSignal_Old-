...
<script type="text/javascript" language="javascript">
    ...
    function fillColumns(id) {
        ...
        document.getElementById("latitude").value = document.getElementById(t1id + (lowerLimit + 22)).innerHTML;
        document.getElementById("longitude").value = document.getElementById(t1id + (lowerLimit + 23)).innerHTML;
    ...
    function setDropdownVisibility(){
        ...
        if(no_of_sides == '1'){
            document.getElementById("side_2_name").value = "";
            ...
            document.getElementById("side_2_name").disabled = true;
            ...
            document.getElementById("side_2_name").style.backgroundColor = "lightgrey";
            ...
            document.getElementById("side_4_name").disabled = true;
            document.getElementById("side_5_name").disabled = true;
            document.getElementById("side_2_name").style.backgroundColor = "";
            document.getElementById("side_3_name").style.backgroundColor = "lightgrey";
            document.getElementById("side_4_name").style.backgroundColor = "lightgrey";
            document.getElementById("side_5_name").style.backgroundColor = "lightgrey";
    ...
    function openMapForCord() {
                              var url="junctionCont?task=GetCordinates1";//"getCordinate";
    ...
    function openMap(longitude, lattitude) {
                            ...
                            var url="junctionCont?task=showMapWindow&logitude="+y+"&lattitude="+x;
    ...
    function ViewPlanInfo(junction_id, program_version_no, no_of_sides) {
        ...
        var url = "PlanInfoCont?" + queryString;
                                            ...
                                            <table name="table1" border="1" width="100%" align="center" class="reference">
                                                ...
                                                <c:forEach var="list" items="${requestScope['junction']}" varStatus="loopCounter">
                                                    <tr class="row" onMouseOver=this.style.backgroundColor='#E3ECF3' onmouseout=this.style.backgroundColor='white'>
                                                        ...
                                                        <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${list.latitude}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${list.longitude}</td>
                                                        <td>
                                                        <input type="button" class="btn"  value ="View Map" id="map_container${loopCounter.count}" onclick="openMap('${list.longitude}' , '${list.latitude}');"/>
                                                    </td>
                                                    </tr>
                                                </c:forEach>
                                                <tr>
                                            ...
                                            <table name="table" class="reference"  border="1" align="center">
                                                ...
                                                <tr>
                                                   <th  class="heading">File No</th>
                                                    ...
                                                    <td>
                                                        <input class="input" size="15" type="text" id="remark" name="remark" value="" disabled><br>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="heading">Longitude</th>
                                                <td><input class="input" type="text" id="longitude" name="longitude" value="" size="20"  required disabled></td>
                                                <th class="heading">Latitude</th>
                                                <td><input class="input" type="text" id="latitude" name="latitude" value="" size="20" required disabled><input class="button" type="button" id="get_cordinate" value="Get Cordinate" onclick="openMapForCord()">
                                                </td>
                                                </tr>
                                                <tr>
