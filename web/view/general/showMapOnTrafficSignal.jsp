<%--
    Document   : timeShower
    Created on : Aug 6, 2018, 12:28:18 PM
    Author     : Robin Singh
--%>
...
<!--            <tr background="/img/viewMap4.png">-->
            <tr>
                <td>
                    <DIV id="body" class="maindiv" style="background-image: url('/img/viewMap4.png');">
...
<!--                                            <td><div style="width: 50px; height: 100px;"></div></td>-->
                                            <td align="right">
                                                <div id="div_upper" style="width: 100px; height: 80px; background-color: transparent;">
<!--                                                    <table align="center" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table border="0" width="50%" align="center">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" colspan="2"><label id="label_upper" style="color: black"></label></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table align="center" border="0" style="vertical-align: bottom" width="100%">
                                                        <tr>
                                                            <td align="center" colspan="2"><label id="label_right" style="color: black"></label></td>
                                                        </tr>
                                                        <tr>
...
<!--                                            <td rowspan="3">
                                        ...
                                        <tr>
                                            <td align="right">
                                                <div id="div_left" style="width: 100px; height: 80px;  background-color: transparent;">
<!--                                                    <table align="left" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table width="50%" align="center">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" colspan="2"><label id="label_left" style="color: black"></label></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table align="right" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="center"><label id="label_lower" style="color: black"></label></td>
                                                        </tr>
                                                    </table>
                                                </div>
                                            </td>
...
<!--                                                    <table  width="100%" border="0">
                                            ...
                                            <td>
                                                <div id="div_right" style="position: static; width: 100px; height: 80px;  background-color: transparent;">
<!--                                                    <table align="right" border="0" width="100%">
                                                        <tr>
                                                            <td align="center" id="side4"></td>
                                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div id="div_lower" style="width: 100px; height: 80px;  background-color: transparent;">
<!--                                                    <table align="center" border="0" style="vertical-align: bottom" width="100%">
                                                        <tr>
                                                            <td align="center" colspan="2"><label id="label_right" style="color: black"></label></td>
                                                        </tr>
                        ...
                        <div id="div_signals" style="visibility: hidden;border: 1px solid red">
                            ...
                            <div id="div_greySignal" style="position: absolute;"></div>
